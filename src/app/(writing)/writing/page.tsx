...
export const metadata: Metadata = {
  title: 'Writing',
  description: 'Essays, book reviews, and updates on my novel-in-progress.',
}
  ...
  return (
    <div className="space-y-10">
      <div className="space-y-6">
        <h1 className="font-serif text-4xl text-zinc-800">Writing</h1>
        <WritingNav activeHref="/writing" />
      </div>
